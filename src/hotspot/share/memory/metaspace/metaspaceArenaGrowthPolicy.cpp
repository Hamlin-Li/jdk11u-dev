...
#define DEFINE_CLASS_FOR_ARRAY(what) \
  ...
  if (is_class) {
    ...
    case Metaspace::AnonymousMetaspaceType:         return &chunk_alloc_sequence_anon_class;
    ...
    case Metaspace::AnonymousMetaspaceType:         return &chunk_alloc_sequence_anon_non_class;
