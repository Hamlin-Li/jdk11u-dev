...
public:
  ...
  bool is_free() const            { return _state == Free; }
  bool is_in_use() const          { return _state == InUse; }
  bool is_dead() const            { return _state == Dead; }
  void set_free()                 { _state = Free; }
  void set_in_use()               { _state = InUse; }
  void set_dead()                 { _state = Dead; }
